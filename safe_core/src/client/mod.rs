...
use safe_nd::{
    ...
    Coins, IDataAddress, ImmutableData, MDataAddress, MDataPermissionSet as NewPermissionSet,
    MDataSeqEntryAction as SeqEntryAction, MDataUnseqEntryAction as UnseqEntryAction,
    MDataValue as Val, Message, MessageId, MutableData as NewMutableData, PublicKey, Request,
    Response, SeqMutableData, Transaction, UnpubImmutableData, UnseqMutableData, XorName,
};
...
mod tests {
    ...
    pub fn adata_permissions_test() {
        random_client(move |client| {
            ...
            let sim_client1 = sim_client.clone();
    ...
    pub fn set_and_get_owner_adata_test() {
        ...
        random_client(move |client| {
            ...
            let sim_client = SecretKey::random().public_key();
            let sim_client2 = SecretKey::random().public_key();
            ...
            let owner2 = ADataOwner {
                public_key: PublicKey::Bls(sim_client.clone()),
                data_index: 2,
                permissions_index: 1,
            };

            let owner3 = ADataOwner {
                public_key: PublicKey::Bls(sim_client2.clone()),
                data_index: 2,
                permissions_index: 1,
            };
