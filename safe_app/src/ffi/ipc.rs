...
mod tests {
    ...
    use safe_authenticator_ffi::test_utils as auth_ffi_utils;
    ...
    fn base_64_encoding() {
        ...
        match auth_ffi_utils::auth_decode_ipc_msg_helper(&auth, &encoded) {
            Err((-1, None)) => (),
        ...
        let decoded = unwrap!(auth_ffi_utils::auth_decode_ipc_msg_helper(&auth, &encoded));
