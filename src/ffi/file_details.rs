...
impl FileDetails {
    ...
    fn deallocate(self) {
        unsafe {
            helper::dealloc_utf8_alloced_from_rust(self.content,
                                                   self.content_len);
        }
...
impl FileMetadata {
    ...
    pub fn deallocate(&mut self) {
        unsafe {
            helper::dealloc_utf8_alloced_from_rust(self.name, self.name_len);
            helper::dealloc_utf8_alloced_from_rust(self.user_metadata,
